                            ...
                            <div class="col-md-6">
                                ...
                                <?php
                                    if(isset($error_msg['village3'])) {
                                        ...
                                        ?>
                                        <div class="exist" data-exists="<?= $error_msg['district3'];?>"></div>
                                <?php }
                                ?> 
                                </p>
                            </div>
                                 ...
                                 <script>
                                  const added = $('.add-village').data('added')
                                    ...
                                    if(null3){
                                     ...
                                     const null4 = $('.not-null4').data('null4')
                                    if(null4){
                                      Swal.fire({
                                            icon: 'error',
                                            title: 'Oops...',
                                            text: 'Area/Village field is required'
                                          })
                                    }
                                     const exists = $('.exist').data('exists')
                                    if(exists){
                                      Swal.fire({
                                            icon: 'error',
                                            title: 'Oops...',
                                            text: 'Area/Village is already exist.Please try another'
                                          })
                                    }
                                 </script>
