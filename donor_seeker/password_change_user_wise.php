   ...
   $id = $_SESSION['id'];
    if($_POST)
    {
        ...
        if(!$sql)
        {
            ...
            header("location:password_change_user_wise.php?error=error");
        }
        else
        {
            echo "Updated Password";
            header("location:view_own_profile.php?password_update=password_update");
        }
      }
    }
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <?php
                              ...
                              <?php }
                                    if(isset($_GET['error'])) { ?>
                                      <div class="not_change" data-wrong3="<?= $_GET['error']; ?>"> 
                                    </div>
                               <?php }
                                ?>
                                ...
                                <script src="sweetAlert/jquery-3.5.0.min.js"></script>
                                 ...
                                 <script>
                                  ...
                                  const wrong3 = $('.not_change').data('wrong3')
                                    if(wrong3){
                                      Swal.fire({
                                            icon: 'error',
                                            title: 'Oops...',
                                            text: 'Your password was not changed...!!!'
                                          })
                                    }
                                 </script>
