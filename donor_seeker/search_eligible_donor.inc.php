 <?php
   ...
   include("header.php");
    ...
    {
        $token = "individual";
        send_mail($_GET['id'] , $_GET['id2'] , $token);// individual mail
    }
    ...
    if(isset($_GET['id3'])) //id3 = post id
    {
        ...
        $token = "all";
          ...
          {
            send_mail($row['id'] , $post_id , $token); // All id mail
          }             
    }


    function send_mail($id , $id2 , $token)
    {
        ...
        require_once "PHPMailer/Exception.php";
          ...
          if ($mail->send()) {
              ...
              //echo $status;
              header("location:search_eligible_donor.php?idd=".$id2."&id=".$id."&token=".$token); //$id2 = post_id
          } else {
              //$status = "failed";
              //$response = "Something is wrong: <br><br>" . $mail->ErrorInfo;
              header("location:search_eligible_donor.php?error=error");
          }
    }
?>