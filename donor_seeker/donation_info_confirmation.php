...
<html lang="en" dir="ltr">
  ...
  <body>
       ...
       <thead>
        <hr>
         <h4 style="text-align: center;">You are Suppose to Donate/Take Blood to Below Information.Please Check-out for get further blood donation notification.</h4> 
         <tr>
    ...
    ?> 
     <?php
        if(isset($_GET['id']) && isset($_GET['id2']))
        {
          ...
          $sql2 = mysqli_query($connection,"INSERT INTO `donation_infos`(`post_id`, `donor_id`, `Last_donate`, `Division` , `blood_group` , `donee_location`, `donee_name`, `donee_contact`) VALUES ('$post_id' , '$donor_id' , '$donation_date' , '$Division' , '$blood_group' , '$donation_place' , '$donee_name' , '$donee_contact');");

           $update = mysqli_query($connection, "UPDATE donor_infos SET Last_donate = '$donation_date' WHERE id = '$donor_id'");
