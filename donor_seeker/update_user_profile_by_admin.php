<?php 
    ...
    if($_POST)
    {
        ...
        if(count($error_msg) == 0)
        {
            ...
            $Phone = $_POST['phone'];
            $E_mail = $_POST['email'];
            /* If no update / kept previous value */
        ...
        {
            /* Not updated */
            header("location:update_user_profile_by_admin.php?error=error &id=".$id);
            ob_end_flush();
        }
        else
        {
            /* Updated */
            header("location:view_user_full_profile_by_admin.php?success=success &id=".$id);
            ob_end_flush();
        }
      }
    }
                                         ...
                                         <script>
                                            ...
                                            if(wrong2){
                                              Swal.fire({
                                                    icon: 'error',
                                                    title: 'Oops...',
                                                    text: 'User profile was not update...!!! try again.'
                                                  })
                                            }
                                         </script>
