...
<?php
   ...
   $sql = "SELECT * from donor_infos WHERE Blood_Group = '$blood_group' and Division = '$division' and Date_of_Birth <= '$eighten' and Date_of_Birth >= '$sixty' and Weight >= 50 and  status = 'active' and Last_donate <= '$eligible_date'";
