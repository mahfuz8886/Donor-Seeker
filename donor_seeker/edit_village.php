<?php
     ...
     if($_POST)
    {
        ...
        {
         $error_msg['edit_village1'] = "Area/Village is Field Can't be empty.";
        }
                                ...
                                <p>
                                    ...
                                    if(isset($error_msg['sub_district1'])) {
                                        echo "<div class='error'>" . $error_msg['sub_district1']. "</div>";
                                         ?>
                                        <div class="not-null3" data-null3="<?= $error_msg['sub_district1'];?>"></div>
                                <?php }
                                ...
                                <p>
                                    ...
                                    if(isset($error_msg['village1'])) {
                                        echo "<div class='error'>" . $error_msg['village1']. "</div>";
                                         ?>
                                        <div class="not-null4" data-null4="<?= $error_msg['village1'];?>"></div>
                                <?php }
                            ...
                            <div class="col-md-6">
                                ...
                                <?php
                                    if(isset($error_msg['edit_village1'])) {
                                        ...
                                        ?>
                                        <div class="not-null5" data-null5="<?= $error_msg['edit_village1'];?>"></div>
                                  <?php }
                                ?> 
                                </p>
                            </div>
                                  ...
                                  const edit = $('.edit-village').data('edit')
                                    ...
                                    if(null3){
                                      Swal.fire({
                                            icon: 'error',
                                            title: 'Oops...',
                                            text: 'Sub-District/Police Station field is required'
                                          })
                                    }
                                     const null3 = $('.not-null3').data('null3')
                                    if(null3){
                                      Swal.fire({
                                            icon: 'error',
                                            title: 'Oops...',
                                            text: 'Area/Village is required'
                                          })
                                    }
                                    const null5 = $('.not-null5').data('null5')
                                    if(null5){
                                      Swal.fire({
                                            icon: 'error',
                                            title: 'Oops...',
                                            text: "Area/Village Can't be empty."
                                          })
                                    }
                                 </script>
