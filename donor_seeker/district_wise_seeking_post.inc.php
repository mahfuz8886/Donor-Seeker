...
<?php
    ...
    $sql = "SELECT * from donor_infos WHERE Blood_Group = '$blood_group' and Division = '$division' and District = '$district' and Date_of_Birth <= '$eighten' and Date_of_Birth >= '$sixty' and Weight >= 50 and  status = 'active' and Last_donate <= '$eligible_date'";
...
?>  
    ...
    <table class="table table-striped">
     ...
     <!-- Here is start individual mail sent procedure -->
